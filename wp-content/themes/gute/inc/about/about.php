		...
		// Main welcome content
			...
			'quick_links' => array(
                ...
                'documentation_url' => array(
                    ...
                    'url'    => 'https://gp.wpcolors.net/',
                    'button' => 'primary',
                ),
                'live_url' => array(
                    'text'   => esc_html__( 'GUTE PRO DEMO', 'gute' ),
                    'url'    => 'https://wpcolors.net/gute/gute-preview/',
                    'button' => 'primary',
                ),
                'video_url' => array(
			...
			'getting_started' => array(
				...
				'six' => array(
					...
					'button_url'  => 'https://wpcolors.net/gute/gute-preview/',
					'button_type' => 'link',
					'is_new_tab'  => true,
					),
                'seven' => array(
...
function gute_admin_notice_option(){
    if(isset($_GET['dismissed']) && $_GET['dismissed'] == 1 ){
        delete_option( 'gotinuer');
        update_option( 'gotinuer12', 1 );
    }
}
