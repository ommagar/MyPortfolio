...
if ( ! defined( 'GUTE_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	    define( 'GUTE_VERSION', '1.2.4' );
}
...
function gute_scripts() {
	...
	wp_enqueue_style( 'gute-default', get_template_directory_uri().'/assets/css/default.css',array(), GUTE_VERSION ,'all' );
	wp_enqueue_style( 'gute-style', get_stylesheet_uri(),array(),GUTE_VERSION,'all' );


	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '20180810', true );
	wp_enqueue_script( 'gute-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), GUTE_VERSION , true );
	wp_enqueue_script( 'gute-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), GUTE_VERSION, true );
 ...
 * header action
 */
require get_template_directory() . '/inc/action/header-action.php';
/**
 * Inline css
 */
